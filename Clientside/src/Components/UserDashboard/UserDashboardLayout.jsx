...
const UserDashboardLayout = ({ children }) => {
  ...
  const [refresh, setRefresh] = useState(0);
    const [refreshsetnoti, setnoti] = useState(0);
...
<Link to="/userdashboard" className="d-flex align-items-center mb-2">
  <FaTachometerAlt className="me-2" />
  Dashboard
</Link>

<Link to="/meals" className="d-flex align-items-center mb-2">
  <FaUtensils className="me-2" />
  Meals
</Link>

<Link to="/execises" className="d-flex align-items-center mb-2">
  <FaDumbbell className="me-2" />
  Exercises
</Link>

<Link to="/progress" className="d-flex align-items-center mb-2">
  <FaChartLine className="me-2" />
  Progress
</Link>
<Link to="/Goals" className="d-flex align-items-center mb-2">
  <GoGoal className="me-2" />
  Goal
</Link>
<Link to="/blog" className="d-flex align-items-center mb-2">
  <FaBlog className="me-2" />
  Blog
</Link>
<Link to="/home" className="d-flex align-items-center mb-2">
